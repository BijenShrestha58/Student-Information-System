...
export class MarksService {
  ...
  async createAll(createMarkDtos: CreateMarkDto[]) {
    ...
    for (const createMarkDto of createMarkDtos) {
      ...
      let existingMark = await this.marksRepository.createQueryBuilder('marks')
      .where('marks.student = :student', { student: student })
      .andWhere('marks.subject = :subject', { subject: subject })
      .andWhere('marks.academicYear = :academicYear', { academicYear: academicYear })
      .getOne();
